...
Este primer módulo me permitió incorporar herramientas que cambian bastante la forma de encarar trabajos técnicos. Lo más importante es entender la separación entre contenido y formato: a diferencia de los procesadores de texto tradicionales, donde el formato suele interferir constantemente, lenguajes como LaTeX o HTML obligan a pensar primero en la estructura y después en la presentación.

También destaco el uso de notebooks como herramienta que integra cálculo, análisis y documentación en un mismo entorno, lo que resulta mucho más eficiente para trabajos técnicos. Por otro lado, la introducción a GitHub y archivos como README.md aporta una base para organizar proyectos de manera clara y replicable.

En lo personal, considero que estas herramientas van a ser clave a lo largo de la carrera, tanto para la elaboración de informes como para trabajos más complejos. Además, son habilidades directamente aplicables al ámbito profesional, donde la claridad, la organización y la trazabilidad de la información son fundamentales.
...
\includepdf[pages=-, pagecommand={\thispagestyle{plain}}]{manuelrobycv.pdf}
